...
![](assets/95daa04d-b9dd-4320-a77a-13e394a4af4d.png)
...
![](assets/32b35bcc-79c4-40c2-907a-39bc8c15228b.png)
...
![](assets/36fcdc48-7e5f-4e86-b986-782d1d595a98.png)

Kali 更新后，运行`apt-get install xplico`命令。出现提示时，一定要按*Y*继续：

![](assets/54a1e65a-a309-4584-b5de-164b7accd98f.png)
...
![](assets/4e96ad8d-d35b-4524-b41f-44b371b2a48d.png)

完成这些步骤后，现在可以通过单击应用程序| 11-取证| Xplico:

![](assets/9c98618a-8df1-4e09-8940-db905bfe7631.png)
...
![](assets/dd5593a9-c678-4fce-927f-1cdc1a3576e5.png)
...
![](assets/04b86553-c139-4e6f-891e-05ef94807e9f.png)

在下面的屏幕截图中，我输入了`HTTP-WEB`作为案例名称。单击“创建”继续。HTTPWEB 案例现已创建。单击 HTTPWEB 继续进入会话屏幕：

![](assets/6a3d523a-7a8b-4313-b2a9-a7753643b773.png)

现在，我们通过单击左侧菜单中的 new session（新建会话）选项，为案例的此实例创建一个新会话：

![](assets/3f219cd2-8fe9-43a4-872e-45a7b64305b6.png)

我们为会话命名，然后单击“创建”继续：

![](assets/670b1932-4e7c-4245-9d2c-d9344bc0b5f1.png)

我们的新会话已创建，名称为 HTTPWEB：

![](assets/0de63e01-7954-4174-a10e-fe14336a042f.png)

一旦输入了我们的案例和会话详细信息，我们就会看到 Xplico 主界面窗口，其中显示了在上传和解码我们的`.pcap`文件后发现的各种可能的工件类别，包括 HTTP、DNS、Web Mail 和 Facebook 类别：

![](assets/1fc45d73-d311-4841-bf02-a6cc5f6452c7.png)
...
![](assets/f2ebc82f-c832-4807-be36-dfb18064295a.png)

文件解码后，我们可以看到右下角 Calls 类别中列出了两个结果：

![](assets/4ba8c5f5-c015-4415-a2f7-e2389b70d480.png)

要开始探索和分析 VoIP 呼叫的详细信息，请单击左侧菜单上的 VoIP 选项：

![](assets/d491bd8e-35d1-4410-bacc-376d18a8418e.png)

单击 Sip 子菜单，我们将看到呼叫的详细信息。我们可以看到电话是从`"Freeswitch" <sip:5555551212@192.168.1.111>`打到`Freeswitch <sip:5555551212@192.168.1.112>`：

![](assets/9a1b5c19-3783-470f-9178-7724209f694b.png)

点击持续时间详情（`0:0:19`）进一步分析和探索：

![](assets/2b68a87a-ef13-4d8a-b9e7-3e9b85d213bb.png)

首先点击`cmd.txt`查看信息文件和日志：

![](assets/18cabebb-fc4f-483d-b230-f1fd6d4bc4a6.png)

在前面的屏幕截图中，我们可以看到对话中的数字、日期、时间和持续时间的详细信息。还可以选择在任意一端播放对话：

![](assets/2732140b-29de-438b-a4b5-f4d065decbf8.png)
...
![](assets/e16c3e06-7225-4fb2-a710-725c764d4497.png)
...
![](assets/9c56d86e-1994-43cb-8109-fe9740659493.png)

单击-（无主题）-字段后，我们现在可以看到电子邮件的内容：

![](assets/6fdc4e7f-bbdf-4402-96a9-2341105ccaba.png)
