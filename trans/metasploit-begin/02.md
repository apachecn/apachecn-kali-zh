...
![](assets/e85a698c-f244-421e-b46c-1496e7c37dcd.jpg)
...
![](assets/16b5716b-c101-4285-a427-77c090a7686a.jpg)
...
![](assets/948299dc-e88e-40b3-b583-92c98be471b8.jpg)

4.  接受许可协议：

![](assets/37360364-f22e-4e60-b60a-6caebd81708d.jpg)

5.  选择要安装 Metasploit 框架的位置：

![](assets/a28ef203-ee97-45ed-bce5-5a7b188366cb.jpg)

6.  单击“安装”继续：

![](assets/a64ccc65-4dc0-4209-a418-93116a8ae90c.jpg)

Metasploit 安装程序将所需文件复制到目标文件夹：

![](assets/d242b188-a46b-471d-aae8-d0825cf5d15a.jpg)

7.  单击 Finish 完成 Metasploit Framework 安装：

![](assets/c878fd1f-ff84-45ac-90b0-3971c7181e24.jpg)
...
![](assets/143902e3-850a-4b7b-ac5e-db98ba95c8ef.jpg)
...
![](assets/1dfe9afc-cc52-4603-a7f8-891eda282414.png)
...
![](assets/b6036fa0-9718-4fc6-8526-c654958a9ca3.png)

5.  接受许可协议：

![](assets/312d3e69-895c-4dd2-94a7-73bff70cb44a.png)

6.  选择安装目录（对于默认安装，建议将此*保持为*：

![](assets/a38fbf56-bf37-49a8-9dd7-82647526ec1c.png)

7.  选择“是”将 Metasploit Framework 作为服务安装：

![](assets/75dcc880-dd76-496c-8267-0dc1a687a613.png)

8.  确保禁用可能已在系统上运行的任何防病毒或防火墙。防病毒和防火墙等安全产品可能会阻止许多 Metasploit 模块和漏洞攻击正常运行：

![](assets/07c47d42-f5da-4841-bf01-14a4808d5c13.png)

9.  输入 Metasploit 服务将在其上运行的端口号。（对于默认安装，建议将此*保持为*：

![](assets/12fa1cfc-00c1-4964-a9b1-909bf640e34f.png)

10.  输入 Metasploit Framework 将在其上运行的主机名。（对于默认安装，建议将此*保持为*：

![](assets/42f7dc6d-9cb9-4503-b274-454043db3bcc.png)

11.  单击“前进”继续安装：

![](assets/0012c336-2aa2-4d7d-88d5-95b02ad804cc.png)

![](assets/5eb59e40-b0ad-4570-98ca-4e786f629d9a.png)

12.  现在，Metasploit Framework 安装已完成：

![](assets/c17ffcf5-7b16-4c4f-b12a-594122c2c6ef.png)

让我们尝试通过命令行界面访问它：

1.  打开终端窗口，键入命令`msfconsole`并点击*回车键。*您应该在屏幕上看到以下内容：

![](assets/95f01ef6-4ea6-4837-b4df-480d3b7ec72c.png)
...
![](assets/bb1609f4-b6ac-4886-8014-b02c4f40428e.png)

2.  双击 Metasploitable VMware 虚拟机配置文件以打开虚拟机。这需要事先安装 VMPlayer 或 VMware 工作站：

![](assets/a48daa75-0936-4a1a-b21e-3977022c77c2.jpg)

3.  点击绿色`Play`图标启动虚拟机：

![](assets/b251559d-246e-492f-833e-65b23241b494.jpg)
