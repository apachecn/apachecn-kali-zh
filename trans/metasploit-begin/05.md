...
![](assets/94b51c7c-64c1-43d4-bcdb-edebf446814a.jpg)
...
![](assets/5eecfeec-f7fe-47f4-ae8a-9f8c642ebe4c.png)
...
![](assets/e45c6180-8848-4809-8d94-64d58b5bb055.jpg)
...
![](assets/a0426fe2-73b4-4d23-891b-085515c7aa8f.jpg)
...
![](assets/5d9069e5-cf30-4bdf-a346-60c38ec43845.jpg)

*   `services`命令：一旦 NMAP 扫描结果导入数据库，我们就可以查询数据库，过滤出我们可能感兴趣利用的服务。带有适当参数的`services`命令，如下图所示，查询数据库并过滤掉服务：

![](assets/5a695ec4-3dd5-4f5b-836b-0b7912bff0a0.jpg)
...
![](assets/9223b785-ae38-46e7-957e-16087b09880f.jpg)
...
![](assets/0a33772e-a142-49d7-b3eb-6b5ee9a0bbfb.jpg)
...
![](assets/8fed6a00-c683-486a-93f3-e961922bbc08.jpg)
...
![](assets/f4ddffeb-145f-4afc-850e-2590ced22181.jpg)
...
![](assets/c6aadc6e-f7e5-4da0-97bf-526c657ad72c.jpg)

# 使用 Metasploit 辅助工具进行漏洞检测

我们在上一章中看到了各种辅助模块。Metasploit 框架中的一些辅助模块也可用于检测特定漏洞。例如，以下屏幕截图显示了检查目标系统是否易受 MS12-020 RDP 漏洞攻击的辅助模块：

![](assets/afb449c4-f990-4f5b-ad6b-a0066c091ae9.jpg)
...
![](assets/f56fa20b-464b-48ad-9ba9-31e217e28f1b.jpg)
...
![](assets/c00723e3-f35c-4392-bd1b-7ad999af31e1.jpg)
...
![](assets/429cebb4-0e06-48df-94a8-d719bef4ad30.jpg)

将 MeterMeter 迁移到`explorer.exe`后，加载`espia`插件，然后启动`screengrab`命令，如下图所示：

![](assets/fdfeb5d8-5ad0-404f-a665-699f1fdd542f.jpg)

我们受损系统的屏幕截图已保存（如下所示），我们可以注意到受害者正在与 FileZilla 服务器交互：

![](assets/b6512e76-1121-44a5-9877-167ec730c868.jpeg)
...
![](assets/8c85c478-0837-42ba-80aa-c25725ff7a00.jpg)
