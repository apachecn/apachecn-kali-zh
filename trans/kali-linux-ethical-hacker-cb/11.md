...
![](assets/cfdac0f3-db3e-47b7-a35a-b2276416746c.png)
...
![](assets/2dfd262a-fd28-409f-bb78-133065942415.png)
...
![](assets/b5d6967b-66de-4c68-b315-968da0c484b9.png)

3.  完成后，我们会重新启动手机，并在应用程序菜单中看到 NetHunter。

4.  但在开始之前，我们需要在 Play Store 的手机上安装 BusyBox：

![](assets/7737d945-b9df-43cd-818a-1d8550792597.png)

5.  完成后，我们运行应用程序并单击安装：

![](assets/4937c08d-42c4-4bae-8b44-00bccab15efb.png)

6.  接下来，我们打开 NetHunter，从菜单中选择 Kali Chroot Manager：

![](assets/26de7fde-d27a-4dc7-9486-a9cbd4893e5e.png)

7.  我们单击 ADD METAPACKAGES，我们将为下一个配方做好准备：

![](assets/267e5afc-ae24-477b-b3f1-fa7bde81109e.png)
...
![](assets/a458fd73-32e6-4201-b3f7-74f0a464d2ab.png)

3.  我们将看到两个选项卡：PowerSploit 和 Windows CMD：

![](assets/83a24814-f368-47f4-b147-e753dd4abae7.png)

4.  让我们试试 Windows 命令；在“编辑源代码”框中，我们可以键入要执行的命令。我们甚至可以从选项中选择 UAC 旁路，使命令在不同版本的 Windows 上以管理员身份运行：

![](assets/92c6b823-d331-4bab-aa8d-ec2f87cdd54e.png)
...
![](assets/b84b1f49-97fb-476e-8f20-f1088ace13f7.png)

6.  然后，我们将手机连接到 Windows 10 设备，并从菜单中选择执行攻击：

![](assets/875d98b8-8196-4f7a-adbe-e8806fbd39a4.png)

7.  我们将看到正在执行的命令：

![](assets/1bfe0cbd-8d94-4460-943e-20e0966813d5.png)
...
![](assets/d15cac69-980b-450b-9400-8e5209b004eb.png)
...
![](assets/11ac900d-44c1-4e80-9c35-5b9b58ac556a.png)

7.  internet 上有多个脚本可用于使用 NetHunter 执行多个攻击：

![](assets/b81408b9-dae7-4cdf-914f-c4563ebbddc4.png)
...
![](assets/fdbda1f9-6f53-4510-94d1-ad10caba6118.png)

2.  它将在“常规设置”选项卡中打开。在这里，我们可以选择界面和其他选项，例如捕获 cookie。这可以通过使用 NetHunter 支持的外部无线卡执行邪恶孪生攻击来执行无线攻击：

![](assets/6ed7c12e-6e1c-4b6e-801a-caee4cff87a3.png)
...
![](assets/d27a833a-883d-4c18-9d16-82a0fbd1c704.png)

6.  要更改要侦听的接口，请切换到“常规设置”选项卡，并从下拉列表中的接口列表中进行选择：

![](assets/128f70c5-96dc-4844-8cea-1be090cf2ef0.png)

7.  现在，我们从右侧的选项菜单中单击开始 mitm 攻击。

8.  我们将看到一个终端窗口打开，我们的攻击将被执行。我们将看到攻击捕获的主机信息和密码哈希：

![](assets/e2354787-8e39-46b9-b99b-09889079f494.png)
