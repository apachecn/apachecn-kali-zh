...
![](assets/cc1d780e-ccd2-4f3f-b054-141c3499e331.png)
...
![](assets/7cc7af6c-a717-4d04-b6a4-9300c0e0c4f2.png)
...
![](assets/876033dc-c556-4e9e-9ba0-7353041478a3.png)
...
![](assets/12910d23-e509-4579-844d-6cff03b3e1f9.png)
...
![](assets/a7b2484b-3f08-4036-9d79-1f067b97bddf.png)
...
![](assets/82b6b411-f956-4c4a-a9be-b3e5c517e07e.png)

3.  扫描完成后，Zenmap 将在选项卡中填充以下信息：Nmap 输出、端口/主机、拓扑和主机详细信息：

![](assets/6e90e1d3-439d-45d2-ab7b-96a63d4b6dd1.png)
...
![](assets/015f7cb4-54a1-4aeb-a9bc-d188d6d9095f.png)
...
![](assets/0b8f2560-87b8-4051-b9a0-630e9c35a30a.png)

ARPSoof 将开始连续向两台设备发送**免费 ARP**消息。使用*Ctrl*+*C*将停止 ARP 中毒攻击，ARPSoof 将执行清理操作，恢复受害者与网关之间的工作状态，如下图所示：

![](assets/f2d3675c-f02a-48f4-a950-3465a6a7427b.png)
...
![](assets/4def36d9-0436-4cf4-9a9b-1efd78d50d4d.png)

4.  使用`mkvirtualenv MITMf -p /usr/bin/python2.7`命令创建虚拟环境并下载 MITMf 存储库，如以下屏幕截图所示：

![](assets/80c17ae0-0b98-497f-9d93-8c180e044b97.png)
...
![](assets/1eed32ba-0333-4fc8-8f0e-853a81c5c8bd.png)

要确保成功完成此练习，请按照以下说明进行操作：

1.  在 Kali Linux 上使用**TTERCAP 图形化**设置 MITM 攻击。要执行此任务，请导航到应用程序| 09–嗅探&欺骗| eTerCap 图形，如下所示：

![](assets/dd6e6b03-d096-4a37-9189-76536f24a6ec.png)

2.  打开 eTerCap 后，单击嗅探|统一嗅探：

![](assets/ac42ad1d-6e95-4cd1-9a15-d6b5ce2191f1.png)

3.  将出现一个小弹出窗口。选择您的**网络接口：****eth0**点击**确定**：

![](assets/ddaa88ff-71af-4eca-a610-00f255571e1e.png)

4.  通过导航到主机扫描网络上的所有主机设备|扫描主机：

![](assets/dbc7923e-36ac-4dbd-865b-9a7f6c03cc08.png)

5.  扫描完成后，单击主机|主机列表以查看网络上的目标列表。选择您的目标并点击**添加到目标 1**：

![](assets/99bdad5c-1a3c-4446-9f75-6ca0db075585.png)

6.  成功添加目标后，导航至 Mitm | ARP 中毒，在 Ettercap 上启用 ARP 中毒：

![](assets/232c440a-def6-4d93-b784-4b485b49dfae.png)

7.  将出现一个弹出窗口。选择**嗅探远程连接。**点击**确定**：

![](assets/367bf062-7527-42d3-96d9-3d2f1adde364.png)

8.  接下来，单击开始|开始嗅探以启用 MITM 攻击：

![](assets/2b35fb21-4e12-4997-b43d-53a768911536.png)

9.  接下来，我们将使用**仓鼠**工具来帮助我们操作数据。要打开仓鼠，请导航到应用程序| 09–嗅探&欺骗|仓鼠：

![](assets/4e987849-1294-4108-b92b-8a89d0a0b32c.png)

**仓鼠**将在新的终端窗口上打开命令行界面，并提供 URL`http://127.0.0.1:1234`，用于查看会话信息：

![](assets/701f0c22-a9db-429e-9b98-986a5e761c38.png)
...
![](assets/37986d1e-7e74-4044-8f7b-a2485043098b.png)

11.  使用`ferret -i eth0`命令捕获以太网接口上的 cookie：

![](assets/8d9f2ce6-0cf2-4901-a445-fd2aff2f9c69.png)

12.  在 Kali Linux 上打开 web 浏览器，输入`http://127.0.0.1:1234`进入**仓鼠**代理界面。点击**适配器**：

![](assets/34ae3843-b9a7-4504-9ae4-412f9edd40fa.png)

13.  选择`eth0`适配器，点击**提交查询**：

![](assets/507c9079-0ff6-457a-af30-45abff613640.png)
...
![](assets/8759207a-45f9-422f-9f63-b535b570afec.png)

16.  单击左侧栏中的任何 URL 都将提供受害者可能在其 web 浏览器上看到的图像：

![](assets/e3a8a754-aa8d-49ca-a679-c4c88878cd2d.png)

17.  要查看 cookie/会话详细信息列表，请在 web 浏览器上打开一个新选项卡，然后输入如下所示的 URL：

![](assets/84ae6cf7-2797-4a93-ac4a-e278d46a2a72.png)
...
![](assets/705aa3a4-6d57-426f-8dd7-40e70a641f1c.png)
...
![](assets/38c6a458-8dac-497c-a88f-286c8fa41b6a.png)
...
![](assets/a61193c8-6baf-4c28-b02b-6404c0aeb02c.png)
...
![](assets/89dfe802-ef5b-44d4-a28e-f90baeef1b0e.png)
...
![](assets/18b21eb6-8af4-40df-a889-3df4ad239942.png)

2.  将您当前的工作目录更改为`/usr/share/responder`。接下来，使响应者能够监听网络上的流量，如以下屏幕截图所示：

![](assets/3fd8e538-a762-4930-a514-ed9102bea5f8.png)

我们将在响应程序中使用以下参数：

3.  默认情况下，响应者对受害者进行中毒攻击。每当客户端试图访问网络上的资源（如文件共享）时，都会通过网络发送用户的凭据，如以下屏幕截图所示：

![](assets/084c7f4f-9e5e-4b9e-a6b0-d1c7e333ca0a.png)
...
![](assets/a7842e6c-9ab1-4437-bf96-745ea27cd2cd.png)
...
![](assets/b44e207a-13fe-43ed-8d1d-674f21064db2.png)

代码段中使用的开关提供以下功能：

4.  当受害者试图浏览或访问网络上的任何本地资源时，将出现以下登录窗口：

![](assets/788a6864-c93e-496e-a35b-f05218461830.png)
...
![](assets/4e5797d4-710b-409e-a820-d5f78a2af58b.png)
...
![](assets/bf37db63-389b-4968-a742-e798e2d554c6.png)
...
![](assets/fa41550a-4b36-4874-9498-b9b44f314703.png)
...
![](assets/0e46e174-9a7e-4fa6-a115-bbfa2d2e2bc5.png)
...
![](assets/ae0917ee-9347-47b0-b226-c9e6a4761ed7.png)

2.  选择适当的网络接口，在所有接口上选择“启用混杂模式”，然后单击“开始”开始捕获网络数据包：

![](assets/c630fee5-a4f6-46f4-bc06-4bf2c8b4be03.png)

3.  当网络上发生交易时，**数据包列表**窗格将开始填充网络数据包。单击数据包将在以下**数据包详细信息**窗格中显示其所有详细信息和字段：

![](assets/af5558ed-bc66-4b5f-8e1c-a5d2c73511f5.png)
...
![](assets/42722bca-24e6-4c64-b77d-7244da1f3719.png)

组合过滤器时，需要使用逻辑操作来完成任务。以下是在 Wireshark 中组合过滤器的各种操作符的简短列表：

![](assets/b64167ac-358e-4638-a06e-1b9f6d51add7.png)
...
![](assets/f5f37362-8c54-4227-b8cc-52f135858a86.png)

对话窗口将打开，提供多个选项卡，其中包含各种详细信息，如设备之间的以太网、IPv4、IPv6、TCP 和 UDP 会话，如以下屏幕截图所示：

![](assets/f3fa99eb-394f-490f-b7df-601a994c1d5a.png)
...
![](assets/1ea8187a-0a9f-41ca-9d22-ea443dbc9219.png)
...
![](assets/3e89a7d7-35cc-48b9-8cb6-18ab63449897.png)
...
![](assets/4632f435-c683-478d-bf6e-9e5507cc0676.png)
...
![](assets/e442c01d-4d50-4445-b5f5-916ca37ee78e.png)
...
![](assets/cb1ddc8e-9afa-4c48-9bc9-b926fcb80922.png)

以下结果证明我们的攻击者机器能够在另一个子网上执行扫描和攻击：

![](assets/b6b72db3-be18-457f-b3a5-d656cb91d5c3.png)

4.  此外，在目标上执行 TCP 端口扫描已被证明是有效的，因为所有攻击都是通过`10.10.10.23`机器发送的：

![](assets/dfeeee96-449b-4629-941b-6b24def7a7af.png)
...
![](assets/8780f8af-a73f-474d-a22b-9a1c6201315c.png)

此外，请查看 Windows Defender 版本信息；我们可以看到，所有定义都已删除：

![](assets/4bb8d48c-d2aa-4803-901b-79519a0f6571.png)
...
![](assets/313b6e31-26d8-4c91-9608-7edaa7c392e9.png)
...
![](assets/8a51a46a-4c8b-4c4b-bf92-9fa263c44631.png)
...
![](assets/fbe4f6dd-78bb-4cb1-978a-74e14f34abeb.png)
...
![](assets/28339c2b-c036-43f3-9bae-769d61fad6f8.png)
