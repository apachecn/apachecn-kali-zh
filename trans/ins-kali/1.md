...
欢迎来到*即时Kali Linux*。本书旨在为您提供设置和开始使用 Kali Linux 所需的所有信息。您将学习 Kali 的基础知识、其目录结构、如何使用其常用工具等。
...
本文概述了在各种情况下可用于执行从信息收集到法医调查等不同任务的一些重要工具。Kali收集了 300 多种工具。涵盖所有这些都超出了本书的范围，但对本节中列出的工具的良好理解在任何情况下都会有很大帮助。在本书的下一节中，我们将详细介绍一些工具。
...
*   网络武器关于Kali的视频教程：[http://cyberarms.wordpress.com/2013/07/01/video-training-kali-linux-assuring-security-by-penetration-testing/](http://cyberarms.wordpress.com/2013/07/01/video-training-kali-linux-assuring-security-by-penetration-testing/)
