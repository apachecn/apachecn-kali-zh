...
![](assets/f8272db5-ae83-4598-91c9-30df3268a510.png)
...
![](assets/24352d93-0f0c-49e4-bf73-1f3ea47fed73.png)
...
![](assets/f618edb0-a18f-44ee-9d35-f2392398c999.png)

# 自定义报告

此选项允许用户通过上传并向报告中添加徽标，为特定组织或客户自定义或个性化报告：

![](assets/3df48a33-ed84-4699-808f-373e945763b4.png)

# 扫描器

“扫描仪”选项卡显示可用于扫描的扫描仪数量及其详细信息。添加扫描仪不是 Nessus Home 和 Professional 版本中的选项，但可以在 Nessus Security Center 中添加：

![](assets/acc6c49f-44ed-4be3-854f-69fcc9502735.png)
...
![](assets/4bcd009a-5c54-41bd-a42a-773bf09e0fe7.png)
...
![](assets/7fd8f443-67e6-43f7-9125-2b5b6f097e56.png)
...
![](assets/acfbfe36-cab4-455a-9d3a-d7bc109ae10c.png)
...
![](assets/f5ea04ae-e34a-4398-a6c0-d9b46822de1c.png)

3.  按照说明安装下载的`.msi`文件。

4.  Nessus 要求您在安装过程中创建管理员用户，如下所示：

![](assets/57db9c2b-81fb-4625-aab0-bb183367738c.png)

5.  插入从 Tenable 收到的电子邮件中的激活码，如下所示：

![](assets/e69ded4d-b1a0-4e6a-8c31-a9d4ddd002ca.png)
...
![](assets/96109434-7b4c-4c92-90dd-961851ca8e77.png)
...
![](assets/9d2aed0f-1d94-4634-855b-c2f7eb69cecc.png)

4.  选择要作为 Nmap 包的一部分安装的各种组件。这些实用程序提供了更多功能，例如数据包生成和比较。如果您觉得不需要这些额外的实用程序，可以取消选中该功能，如以下屏幕截图所示：

![](assets/afefabee-2e22-401e-a0c7-a4fe4229ab79.png)
...
![](assets/ec9b1227-1a5d-4d44-90c1-4ede64fcf1c9.png)
...
![](assets/149f6e69-6911-4c85-b752-12c4211dd091.png)
...
![](assets/3f50f265-2586-4e22-ad60-a00bbb57a6c2.png)
...
![](assets/99a6d7ff-3d3e-4cee-bb9a-535e7f3babbb.png)

3.  选择将作为 Nmap 包的一部分安装的各种组件中的哪一个。这些实用程序提供额外的功能，例如数据包生成和比较。如果您觉得不需要这些额外的实用程序，可以取消选中这些功能，如以下屏幕截图所示：

![](assets/b3cf1df8-f754-4862-a1b0-9e214ae56efe.png)
